...
public class Driver
{
	...
	public static void main(String[] args) throws SQLException
	{
		...
		try
		{
			...
			// 2. Prepare statement, calling constructor, pass in SQL. Where salary is >  AND dept = x.
			...
			// 5. Return result set (all from database where above applicable conditions are met.
			display(myRs);
